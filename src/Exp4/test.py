import pandas as pd
import torch
from PEP2CCS.src.Exp3.data_util import get_test_data_set
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default="/root/PEP2CCS/src/Exp4/model.pt", help='Path to the model checkpoint')
