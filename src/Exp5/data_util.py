...
def get_data_set():
    ...
    dd = pd.read_csv('/root/ttest.csv')
    # train_data, valid_data = train_test_split(data, test_size = 001., random_state = 1115)
    train_data, valid_data = data, dd

    # train_data = pd.read_csv('/root/best/0_data/train.csv')
    # valid_data = pd.read_csv('/root/best/0_data/valid.csv')
